...
const UserLoginPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const result = await login({ ...formData, role: 'user' });
      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md">
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600">
            ...
            <Link to="/register/user" className="text-orange-500 hover:text-orange-600 font-semibold">
              Sign up
            </Link>
          </p>
        </div>
        ...
        <div className="mt-4 pt-4 border-t border-gray-200">
          ...
          <div className="flex justify-center space-x-4 mt-2">
            <Link to="/login/admin" className="text-blue-600 hover:text-blue-700 text-sm font-medium">
              Admin Login
            </Link>
